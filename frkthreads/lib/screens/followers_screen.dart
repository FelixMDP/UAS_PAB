  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: backgroundColor,
        elevation: 0,
        title: Text('Followers', style: TextStyle(color: textColor)),
        leading: IconButton(
            ...
            itemBuilder: (context, index) {
              return FutureBuilder<DocumentSnapshot>(
                ...
                builder: (context, userSnapshot) {
                  ...
                  final profileImage = followerData['profileImage'] as String?;
                  final fullName =
                      followerData['fullName'] as String? ?? 'Anonymous';
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder:
                              (context) =>
                                  UserProfileScreen(userId: followers[index]),
                        ),
                      );
                    },
                  );
